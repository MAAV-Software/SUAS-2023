...
if("TRUE" STREQUAL "TRUE")
  set(rotors_evaluation_SOURCE_PREFIX /SUAS-2023/software_ws/src/rotors_simulator/rotors_evaluation)
  set(rotors_evaluation_DEVEL_PREFIX /SUAS-2023/software_ws/devel)
  ...
  set(rotors_evaluation_INSTALL_PREFIX /SUAS-2023/software_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotors_evaluation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/SUAS-2023/software_ws/src/rotors_simulator/rotors_evaluation/${idir}'.  ${_report}")
    endif()
