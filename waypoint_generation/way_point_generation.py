...
for i in range(0, len(way_points)):
    ...
    f.write("\t\t<contact>\n")
    f.write("\t\t\t<ode>\n")
    f.write("\t\t\t\t<mu>0.00001</mu>\n")
    f.write("\t\t\t\t<kp>0.00001</kp>\n")
    f.write("\t\t\t\t<kd>0.00001</kd>\n")
    f.write("\t\t\t</ode>\n")
    f.write("\t\t</contact>\n")
    f.write("\t\t<bounce>\n")
    f.write("\t\t\t<restitution_coefficient>0.00001</restitution_coefficient>\n")
    f.write("\t\t\t<threshold>0.00001</threshold>\n")
    f.write("\t\t</bounce>\n")
    f.write("\t\t<friction>\n")
    f.write("\t\t\t<torsional>\n")
    f.write("\t\t\t\t<ode/>\n")
